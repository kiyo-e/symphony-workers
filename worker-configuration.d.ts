/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 799dd67aa59a3a33a69f46d960e90953)
// Runtime types generated with workerd@1.20260617.1 2026-06-12 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	BACKUP_BUCKET: R2Bucket;
	PROJECT_KEY: "default";
	BACKUP_BUCKET_NAME: "symphony-workspaces";
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	ORCHESTRATOR: DurableObjectNamespace<import("./src/index").ProjectOrchestrator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "ProjectOrchestrator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROJECT_KEY" | "BACKUP_BUCKET_NAME">> {}
}
declare module "*.md" {
	const value: string;
